...
v3 pt_velocity(const RigidBody::Ptr& body, v3 p) {
    return body->v + glm::cross(body->omega, p-body->x);
}

void gra::CollisionDetector::updateMeshMotion(const RigidBody::Ptr& a, const RigidBody::Ptr& b, CollisionInfo& info) {
