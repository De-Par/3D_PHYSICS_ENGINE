...
namespace gra {
    ...
    public:
        ...
        explicit CollisionDetector(Scene& scene) {
            for (const std::shared_ptr<RigidBody>& mesh: scene.meshes) {
        ...
        static void updateMeshMotion(const RigidBody::Ptr& a, const RigidBody::Ptr& b, CollisionInfo& info);
