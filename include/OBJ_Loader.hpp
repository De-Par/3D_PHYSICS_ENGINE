...
// Description: The namespace that holds everything that is needed and used for the OBJ Model Loader
namespace objl {
	...
	// Description: The namespace that holds all the math functions need for OBJL
	namespace math {
	...
	// Description: The namespace that holds all the Algorithms needed for OBJL
	namespace algorithm {
